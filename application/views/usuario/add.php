<?php echo form_open('usuario/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="NOMBRE_USUARIO" value="<?php echo $this->input->post('NOMBRE_USUARIO'); ?>" class="form-control" id="NOMBRE_USUARIO" />
		</div>
	</div>
	<div class="form-group">
		<label for="ALIAS_USUARIO" class="col-md-4 control-label">ALIAS USUARIO</label>
		<div class="col-md-8">
			<input type="text" name="ALIAS_USUARIO" value="<?php echo $this->input->post('ALIAS_USUARIO'); ?>" class="form-control" id="ALIAS_USUARIO" />
		</div>
	</div>
	<div class="form-group">
		<label for="CLAVE_USUARIO" class="col-md-4 control-label">CLAVE USUARIO</label>
		<div class="col-md-8">
			<input type="text" name="CLAVE_USUARIO" value="<?php echo $this->input->post('CLAVE_USUARIO'); ?>" class="form-control" id="CLAVE_USUARIO" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
			...
			<div class="col-md-8">
				<select name="TIPO_USUARIO" class="form-control">
					...
					{
						$selected = ($value == $this->input->post('TIPO_USUARIO')) ? ' selected="selected"' : null;
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="STATUS_USUARIO" value="<?php echo $this->input->post('STATUS_USUARIO'); ?>" class="form-control" id="STATUS_USUARIO" />
		</div>
	</div>
